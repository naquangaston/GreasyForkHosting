...
function start_exe() {
    ...
    if (setValue = GM_setValue, getValue = GM_getValue, location.href.includes("jscompress.com") && getValue("script")) {
        ...
        if (location.href.includes("greasyfork.org") && getValue("script")) {
            ...
            function startwin(e, a = null, n, o) {
                ...
                try {
                    checkWin(window[e]) ? (window[a] = open("", "PROFILES", "width=256,height=305"), window[a].window.document.body.innerHTML = "", window[a].window.document.head.innerHTML = "") : (window[e] = open(o, "PROFILES", "width=256,height=305"), console.log("Making", e, "in", a), console.log(window[e]), console.log("writing defalt styles", "to", e, a), window[e].document.write(`\n<head>\n<style>\n    body {\n-ms-overflow-style: none;  /* IE and Edge */\n  scrollbar-width: none;  /* Firefox */\n    background-color: rgb(54, 57, 63);\noverflow-x: hidden;\n    }\n    img,button{\n       border: 2px solid red;\n       border-radius: 8px;\n       border-style: solid;\n       border-width: medium;\n    }\n    input{\n        border-width:0px;\n        border:none;\n        color:white;\n        background: rgba(0, 0, 0, 0)\n    }\n.name{\ncolor:red\n}\n.Status{\ncolor:blue\n}\n.server_nick{\ncolor:white\n}\nbody::-webkit-scrollbar {\n    display: none;\n}\n\n.hidden {\n  display: none;\n}\n.dropdown {\n  display: inline-block;\n  position: relative;\n}\n#Songs_2{\nmax-height:444px;\n}\n</style>\n</head>\n<body>\n<h2> Custom song upload</h2>\n<input type="file" multiple id="chooseFile"><br><br>\n    <div id="myProgress">\n        <div id="myBar"><span id="TextAl"></span></div>\n    </div>\n    <br>\n    <div id="Files_"></div>\n    <div id="Songs_"></div>\n    <div id="Songs_2"></div>\n    <hr>\n    <script>${Mysrc.toString()};\n    Mysrc();<\/script>\n</body>\n`))
                } catch (e) {}
                return window[a] = window[e], console.log("complete win"), window[a]
            }
            window.startwin = startwin, window.checkWin = checkWin,
                function() {
                    class CustomLogging {
                        constructor(e) {
                            this.title = {
                    ...
                    function loader() {
                        ...
                        var loggedkk = !1;
                        setInterval(() => {
                            if (info.stats = [...aa_stats.classList].includes("active"), info.main = [...aa_main.classList].includes("active"), info.playerAlive = playerAlive, info.wasalive = wasalive, info.stats && wasalive && (window.AutoSpawn && setTimeout(Spawn, 500), log_("PlayerStatus", "Died"), playerAlive = !1, wasalive = !1), info.main && !loggedkk) {
